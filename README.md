...
| 章节      | 内容                | 负责人  | 时间   | 地点   |
| ------- | ----------------- | ---- | ---- | ---- |
| 第1章 第1节 | 程序设计的基本元素         | 赵洋 | 09-17 | 空白格 |
| 第1章 第2节 | 过程与他们产生的计算        | 李盛秋 | 09-24 | 空白格 |
| 第1章 第3节 | 用高阶函数做抽象          | 张征 | 10-22 | 空白格 |
| 第2章 第1节 | 数据抽象导引            | 李博 |      |      |
...
- 参与人员
  + 一区
  + 二区：王世川、阮昱彬、白楠、徐琪敏、陈哲、王昭为、黄友勤、周默涵
- 时间地点
  + 时间：周日下午
  + 地点：二区教室
...
| 章节        | 内容                    | 负责人  | 时间   | 地点   |
| --------- | --------------------- | ---- | ---- | ---- |
| 第1章、第2章   | 概览、C语言概述              | 黄友勤 | 09-18 | B616 |
