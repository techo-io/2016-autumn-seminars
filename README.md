...
- 参与人员（请按照自己所在校区填写）
  + 一区：叶忠豪、文灏洋、商庆达、汪泽堃、向政鹏、孙颖凯、徐阳、周雄、李秋豪、张霖瑄、马玉坤、张征、江家伟
  + 二区：肖浩宇
- 时间地点
  + 时间：暂定周六下午，具体时间待更新
...
| 第4章 第1 ~ 3节  | 处理器体系结构（顺序）  |      |      |      |
| 第4章 第4 ~ 6节  | 处理器体系结构（流水线）|      |      |      |
| 第5章 | 优化程序性能 |      |      |      |
| 第6章 | 存储器层次结构 |      |      |      |
| 第7章 | 链接 |      |      |      |
| 第8章 | 异常控制流 |      |      |      |
...
| 章节 | 内容 | 负责人 | 时间 | 地点 |
| ---- | ---- | ------ | ---- | ---- |
| 第1章 第1、2节 | 程序设计的基本元素、过程与他们产生的计算 |     |      |
| 第1章 第3节、第2章 第1节 | 用高阶函数做抽象、数据抽象导引 |     |      |
| 第2章 第2节 | 层次性数据和闭包性质 |     |      |
| 第2章 第3、4节 | 符号数据、抽象数据的多重表示 |     |      |
| 第2章 第5节 | 带有通用性操作的系统 |     |      |
| 第3章 第1、2节 | 赋值和局部状态、求值的环境模型 |     |      |
| 第3章 第3节 | 用变动数据做模拟 |     |      |
| 第3章 第4、5节 | 并发：时间是一个本质问题、流 |     |      |
| 第4章 第1节 | 元循环求值器 |     |      |
| 第4章 第2、3节 | Scheme的变形——惰性求值、Scheme的变形——非确定性计算 |     |      |
| 第4章 第4节 | 逻辑程序设计算 |     |      |
| 第5章 第1、2节 | 寄存器机器的设计、一个寄存器机器模拟器 |     |      |
| 第5章 第3、4节 | 存储分配和废料收集、显式控制的求值器 |     |      |
| 第5章 第5节 | 编译 |     |      |
